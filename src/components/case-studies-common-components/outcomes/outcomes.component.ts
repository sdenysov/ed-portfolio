...
export const DEFAULT_OUTCOMES_CONFIG: OutcomesConfig = {
  title:
    '“The new design system not only made our product feel unified, it also gave our teams a shared language and toolkit to deliver features faster and with higher quality.”',
...
export class OutcomesComponent {
  @Input() outcomesConfig: OutcomesConfig = DEFAULT_OUTCOMES_CONFIG;
